<template>
  <div class="ContentContainer">
    ...
    <div v-else class="pt-[26px] pb-[15px] px-6 relative flex flex-wrap animate-pulse">
      <div class="bg-gray-200 rounded-full w-20 mb-4 h-3">
      </div>
      <div class="justify-self-end ml-auto w-[120px] h-[72px] md:w-[142px] md:h-[88px] rounded-md relative">
        <div class="h-full relative">
          <div
            ...
            <svg class="w-8 h-8 text-gray-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
              viewBox="0 0 20 18">
              <path
      ...
      <div class="bg-gray-200 rounded-full w-10 bottom-2.5 h-2 absolute">
      </div>
    </div>
  </div>
</template>
