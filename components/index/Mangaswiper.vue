      ...
      <div class="SwiperCard hover:opacity-80 transition-opacity ease-in-out">
        ...
        <div>
          <nuxt-link v-if="index.id != 0" :to="'/comic/' + index.id">
            ...
            />
            <nuxt-img
              class="rounded-md block my-1.5 mx-auto"
              :src="getImageSrc(index.mz)"
              alt="mv_img"
            />
          </nuxt-link>
          <div
            v-else
            class="w-[120px] h-[170px] flex items-center justify-center bg-gray-300 rounded animate-pulse"
          >
            <svg
