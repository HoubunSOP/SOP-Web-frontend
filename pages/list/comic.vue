<template>
  <mainpage>
    <maincolumn>
      <div
        class="px-[22px] pt-[18px] border-b-[2px] border-gray-200 overflow-hidden bg-white box-border"
      >
        <div class="relative mb-0">
          <h1 class="m-0 flex">
            <span
              class="inline-block text-[#242a36] text-base font-bold tracking-wide"
            >
              <i
                class="fa-duotone fa-books"
                style="
                  --fa-primary-color: #4453c1;
                  --fa-secondary-color: #4453c1;
                "
              ></i>
              漫画列表
            </span>
      ...
      <div class="flex flex-wrap margin-[-5px] mt-[10px]">
        ...
        >
          ...
          <p
            class="mt-[8px] text-center whitespace-nowrap text-[#808080] text-[10px] font-normal"
          >
            {{ index.date }}发布
          </p>
        </div>
        ...
        >
          ...
          <div
            class="h-[15px] bg-gray-200 rounded-full w-20 whitespace-nowrap mx-auto"
          ></div>
          <div
            class="mt-[8px] h-[8px] bg-gray-200 rounded-full w-10 whitespace-nowrap mx-auto"
          ></div>
        </div>
      </div>
      <compsPagination
