      ...
      <article>
        <header class="px-[36px] pt-8 pb-6 relative">
          ...
          <h1 class="text-2xl mb-4">
            ...
            <div
              v-else
              class="h-5 bg-gray-200 rounded-full w-40 animate-pulse inline-block"
            ></div>
          </h1>
          <div
          ...
          >
            ...
            <div
              v-else
              class="flex items-center justify-center w-full h-40 md:h-60 bg-gray-300 rounded animate-pulse"
            >
              <svg
        ...
        <div id="post-content">
          ...
          <div
            ...
            v-for="index in 3"
            :key="index"
            class="space-y-2.5 animate-pulse max-w-lg mt-4"
          >
